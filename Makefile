...
# Project:  scene.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile scene.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = scene1.0.0
DISTDIR = /home/loosper/projects/uni/graphics/my_scene/.tmp/scene1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: scene.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
